...
ConfigEntry PlatformConfigFile[] =
{
    ...
    {"HKKey_Save1",               0, &HKKeyMapping[HK_SaveF1],              -1, NULL, 0},
    {"HKKey_Save2",               0, &HKKeyMapping[HK_SaveF2],              -1, NULL, 0},
    {"HKKey_Save3",               0, &HKKeyMapping[HK_SaveF3],              -1, NULL, 0},
    {"HKKey_Save4",               0, &HKKeyMapping[HK_SaveF4],              -1, NULL, 0},
    {"HKKey_Save5",               0, &HKKeyMapping[HK_SaveF5],              -1, NULL, 0},
    {"HKKey_Save6",               0, &HKKeyMapping[HK_SaveF6],              -1, NULL, 0},
    {"HKKey_Save7",               0, &HKKeyMapping[HK_SaveF7],              -1, NULL, 0},
    {"HKKey_Save8",               0, &HKKeyMapping[HK_SaveF8],              -1, NULL, 0},
    ...
    {"HKJoy_Save1",               0, &HKJoyMapping[HK_SaveF1],              -1, NULL, 0},
    {"HKJoy_Save2",               0, &HKJoyMapping[HK_SaveF2],              -1, NULL, 0},
    {"HKJoy_Save3",               0, &HKJoyMapping[HK_SaveF3],              -1, NULL, 0},
    {"HKJoy_Save4",               0, &HKJoyMapping[HK_SaveF4],              -1, NULL, 0},
    {"HKJoy_Save5",               0, &HKJoyMapping[HK_SaveF5],              -1, NULL, 0},
    {"HKJoy_Save6",               0, &HKJoyMapping[HK_SaveF6],              -1, NULL, 0},
    {"HKJoy_Save7",               0, &HKJoyMapping[HK_SaveF7],              -1, NULL, 0},
    {"HKJoy_Save8",               0, &HKJoyMapping[HK_SaveF8],              -1, NULL, 0},
